...
\title{\texttt{NMF}: Unit testing results\footnote{Vignette computed  on Thu Nov  1 16:28:33 2012}}
\date{\texttt{NMF} version 0.8.24 as of November  1, 2012}
\usepackage{Sweave}
\begin{document}
\maketitle

\begin{verbatim}
RUNIT TEST PROTOCOL -- Thu Nov  1 16:28:33 2012 
*********************************************** 
