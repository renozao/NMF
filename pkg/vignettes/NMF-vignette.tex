...
\bibliography{/tmp/Rpkglib_48a66da410e5/NMF/REFERENCES}
...
\begin{itemize}\raggedright
  ...
  \item Other packages: BH~1.51.0-0, bigmemory~4.4.0,
    ...
    NMF~0.15.2, pkgmaker~0.15.2, RColorBrewer~1.0-5,
  ...
  \item Loaded via a namespace (and not attached):
    ...
    parallel~2.15.3, stringr~0.6.2, tools~2.15.3
\end{itemize}
