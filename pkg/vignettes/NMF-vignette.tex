...
\hlfunctioncall{RNGinfo}(res)
\end{alltt}
\begin{verbatim}
##  RNG kind:  Mersenne-Twister / Inversion 
##  RNG state: NMFfit [3743651de793a025c92fbcba341ccdf6]
\end{verbatim}
\begin{alltt}
...
##  RNG state: NMFfitX1 [8788b0b73deecda5e6791f645638dafd]
\end{verbatim}
\begin{alltt}
...
\begin{verbatim}
##  RNG kind:  L'Ecuyer-CMRG / Inversion 
##  RNG state: NMFfit [c25c005454c41d0556f8879aefaea5bb]
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\hlfunctioncall{nmf}(V, 3, my.algorithm, scale.factor = 10, objective = \hlfunctioncall{function}(target, 
    x, ...) \{
...
{\ttfamily\noindent\bfseries\textcolor{errorcolor}{\#\# Error: non-numeric argument to binary operator}}\end{kframe}
\end{knitrout}
...
\begin{itemize}\raggedright
  ...
  \item Other packages: bigmemory~4.3.0,
    ...
    colorspace~1.1-1, digest~0.5.2, doParallel~1.0.1,
    doRNG~1.4.5, foreach~1.4.0, gridBase~0.4-5,
    iterators~1.0.6, knitr~0.8, NMF~0.8.14,
    pkgmaker~0.8.3, RColorBrewer~1.0-5, registry~0.2,
    stringr~0.6.1, synchronicity~1.1.0, xtable~1.7-0
  \item Loaded via a namespace (and not attached):
    compiler~2.15.1, evaluate~0.4.2, formatR~0.6,
    plyr~1.7.1, tools~2.15.1
\end{itemize}
