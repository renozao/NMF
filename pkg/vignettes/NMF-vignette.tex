...
##  RNG state: NMFfit [cb1279c622b0f9861c2cf11d4ef1ccfa]
\end{verbatim}
\begin{alltt}
...
##  RNG state: NMFfitX1 [f2f2f2b646478bb294f8ebe575a8420a]
\end{verbatim}
\begin{alltt}
...
\begin{verbatim}
##  RNG kind:  L'Ecuyer-CMRG / Inversion 
##  RNG state: NMFfit [747ac50d5ced29239e8718d1c064915c]
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{itemize}\raggedright
  ...
  \item Other packages: bigmemory~4.3.0,
    ...
    iterators~1.0.6, knitr~0.8, NMF~0.8.13,
    pkgmaker~0.8.2, RColorBrewer~1.0-5, registry~0.2,
