...
\bibliography{/tmp/tmp.whvXvYdUBB/NMF/REFERENCES}
...
\begin{itemize}\raggedright
  ...
  \item Other packages: bigmemory~4.3.0,
    ...
    knitr~0.8, NMF~0.9.1, pkgmaker~0.9.2,
