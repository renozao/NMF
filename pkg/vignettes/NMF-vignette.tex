...
\bibliography{/tmp/tmp.fxRR6COmp3/NMF/REFERENCES}
...
## lee             0.4466 673513121  1780 1.524   1.524    1
## nsNMF           0.7350    585106   970 1.404   1.404    1
\end{verbatim}
\begin{alltt}
...
## lee             0.4466 0.5789  0.7231 673513121  1780 1.524
## nsNMF           0.7350 0.7895  0.4691    585106   970 1.404
##        cpu.all nrun
## brunet   0.496    1
## lee      1.524    1
## nsNMF    1.404    1
...
\begin{itemize}\raggedright
  ...
  \item Other packages: bigmemory~4.3.0,
    ...
    BiocGenerics~0.2.0, digest~0.5.2, knitr~0.9,
    NMF~0.10, pkgmaker~0.10.2, RColorBrewer~1.0-5,
    registry~0.2, rngtools~1.1, xtable~1.7-0
  \item Loaded via a namespace (and not attached):
    ...
    plyr~1.7.1, stringr~0.6.1, tools~2.15.2
\end{itemize}
