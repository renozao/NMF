...
\bibliography{/tmp/Rpkglib_117019e1fc6b/NMF/REFERENCES}
...
\begin{itemize}\raggedright
  ...
  \item Other packages: BH~1.51.0-1, bigmemory~4.4.3,
    ...
    knitr~1.2.9, NMF~0.17.3, pkgmaker~0.16.4,
    RColorBrewer~1.0-5, registry~0.2, rngtools~1.2,
    synchronicity~1.1.0, xtable~1.7-1
  \item Loaded via a namespace (and not attached):
    codetools~0.2-8, colorspace~1.2-2,
    compiler~3.0.1, dichromat~2.0-0, evaluate~0.4.3,
    formatR~0.7, ggplot2~0.9.3.1, gridBase~0.4-6,
    gtable~0.1.2, labeling~0.1, MASS~7.3-26,
    munsell~0.4, plyr~1.8, proto~0.3-10,
