...
\bibliography{/tmp/Rpkglib_f1a5cd70dfe/NMF/REFERENCES}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: unused argument(s) (target = y, seed = x)}}\begin{verbatim}
...
\begin{itemize}\raggedright
  ...
  \item Other packages: BH~1.51.0-0, bigmemory~4.4.0,
    ...
    NMF~0.14.1, pkgmaker~0.14, RColorBrewer~1.0-5,
