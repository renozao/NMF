...
\bibliography{/tmp/tmp.lNStddbW2V/NMF/REFERENCES}
...
Note that some of the classes defined in the NMF package have gained new slots.
...
{\ttfamily\noindent\itshape\textcolor{messagecolor}{\#\# Compute NMF method 1 ...}}

{\ttfamily\noindent\itshape\textcolor{messagecolor}{\#\# OK}}

{\ttfamily\noindent\itshape\textcolor{messagecolor}{\#\# Compute NMF method 2 ...}}

{\ttfamily\noindent\itshape\textcolor{messagecolor}{\#\# OK}}

{\ttfamily\noindent\itshape\textcolor{messagecolor}{\#\# Compute NMF method 3 ...}}

{\ttfamily\noindent\itshape\textcolor{messagecolor}{\#\# OK}}

{\ttfamily\noindent\itshape\textcolor{messagecolor}{\#\# Compute NMF method 4 ...}}

{\ttfamily\noindent\itshape\textcolor{messagecolor}{\#\# OK}}

{\ttfamily\noindent\itshape\textcolor{messagecolor}{\#\# Compute NMF method 5 ...}}

{\ttfamily\noindent\itshape\textcolor{messagecolor}{\#\# OK}}

{\ttfamily\noindent\itshape\textcolor{messagecolor}{\#\# Compute NMF method 6 ...}}

{\ttfamily\noindent\itshape\textcolor{messagecolor}{\#\# OK}}

{\ttfamily\noindent\itshape\textcolor{messagecolor}{\#\# Compute NMF method 7 ...}}

{\ttfamily\noindent\itshape\textcolor{messagecolor}{\#\# OK}}

{\ttfamily\noindent\itshape\textcolor{messagecolor}{\#\# Compute NMF method 8 ...}}

{\ttfamily\noindent\itshape\textcolor{messagecolor}{\#\# OK}}\begin{alltt}
...
\begin{tabular}{rrrr}
 ...
 & C & R & Speed.up \\ 
  \hline
brunet & 5.11 & 12.45 & 2.44 \\ 
  lee & 5.06 & 13.78 & 2.72 \\ 
  offset & 6.26 & 19.76 & 3.16 \\ 
  nsNMF & 9.14 & 18.51 & 2.03 \\ 
   \hline
\end{tabular}
...
##   algorithm:  brunet 
##   seed:  random 
##   RNG: 403L, 624L, 452835868L, ... [ed7ba52c9c2666ca159b185949fd9d73]
##   distance metric:  'KL' 
##   residuals:  543536 
##   Iterations: 510 
##   Timing:
...
## # RNG state: 403L, 624L, 452835868L, ... [ed7ba52c9c2666ca159b185949fd9d73]
\end{verbatim}
\begin{alltt}
...
\hlcomment{# fit using this NMF object}
...
res1 <- \hlfunctioncall{nmf}(esGolub, 3, nrun = 5, .opt = \hlstring{"v-p"}, seed = 123)
\end{alltt}
...
{\ttfamily\noindent\itshape\textcolor{messagecolor}{\#\# \# RNG kind:  Mersenne-Twister / Inversion \\\#\# \# RNG state: 403, 363, -1643107813, ... [34bb8fe5d1bc6e0ecf3d451c45a247ab]}}\begin{verbatim}
## Runs: 1 2* 3* 4 5 ... DONE
## System time:
##    user  system elapsed 
##   3.092   0.004   3.214
...
\hlcomment{# or use the SEQ backend of foreach: .pbackend=NA or \hlstring{'seq'}}
...
\end{verbatim}
\begin{alltt}
res3 <- \hlfunctioncall{nmf}(esGolub, 3, nrun = 5, .opt = \hlstring{"v"}, .pbackend = \hlstring{"seq"}, 
    seed = 123)
\end{alltt}
...
\hlfunctioncall{nmf.equal}(\hlfunctioncall{list}(res1, res2, res3, res4))
\end{alltt}
\begin{verbatim}
## [1] TRUE
\end{verbatim}
...
\hlcomment{# default NMF algorithm)}
estim.r.random <- \hlfunctioncall{nmfEstimateRank}(V.random, range = 2:6, nrun = 10, 
    seed = 123456)
\hlcomment{# plot measures on same graph}
\hlfunctioncall{plot}(estim.r, ref = estim.r.random)
\end{alltt}
...
{\ttfamily\noindent\itshape\textcolor{messagecolor}{\#\# OK}}\end{kframe}
\end{knitrout}
...
## lee             0.4466 673513121  1780 1.580   1.580    1
## nsNMF           0.7350    585106   970 1.336   1.336    1
\end{verbatim}
\begin{alltt}
...
## lee             0.4466 0.5789  0.7231 673513121  1780 1.580
## nsNMF           0.7350 0.7895  0.4691    585106   970 1.336
##        cpu.all nrun
## brunet   0.496    1
## lee      1.580    1
## nsNMF    1.336    1
...
##   samples: 20 
##  # Details:
##   algorithm:  nmf_4ddd361f1491 
##   seed:  random 
##   RNG: 403L, 173L, 1191562961L, ... [0d87fde5bf092083bd059bcc33d58a3e]
...
##   samples: 20 
##  # Details:
##   algorithm:  nmf_4ddd3ff1649f 
##   seed:  random 
##   RNG: 403L, 383L, 1191562961L, ... [2f2572f5c6b643d37859d97079951964]
##   distance metric:  'KL' 
##   residuals:  1539 
##   parameters: scale.factor=10 
##   Timing:
...
##   samples: 20 
##  # Details:
##   algorithm:  nmf_4ddd662f521d 
##   seed:  random 
##   RNG: 403L, 593L, 1191562961L, ... [7ed64fa772a4b1e68cebc0bfed3cb018]
##   distance metric:  <function> 
##   residuals:  9.181 
##   parameters: scale.factor=10 
##   Timing:
...
err <- \hlfunctioncall{try}(\hlfunctioncall{nmf}(V.neg, 3, my.algorithm, scale.factor = 10))
err
\end{alltt}
\begin{verbatim}
...
##   samples: 20 
##  # Details:
##   algorithm:  nmf_4ddd5c40e099 
##   seed:  random 
##   RNG: 403L, 179L, -963168695L, ... [850b670d66e22c6d00f5d79570d1ce8a]
##   distance metric:  'euclidean' 
##   residuals:  561.4 
##   parameters: scale.factor=10 
##   Timing:
...
##  # Details:
##   algorithm:  nmf_4ddd793a9999 
##   seed:  random 
##   RNG: 403L, 389L, -963168695L, ... [7d13c1cc60f9b6390bf7ebfc74dce591]
##   distance metric:  'euclidean' 
##   residuals:  334.3 
##   parameters: scale.factor=10 
##   Timing:
...
##  # Details:
##   algorithm:  snmf/r 
##   seed:  NMF.seed.4ddd1ef8b85 
##   RNG: 403L, 25L, -671852523L, ... [e0cc5847b800083c2460eb9eaa25bd4e]
##   distance metric:  <function> 
##   residuals:  195.6 
##   Iterations: 105 
##   Timing:
...
\begin{itemize}\raggedright
  ...
  \item Other packages: bigmemory~4.3.0,
    ...
    knitr~0.8, NMF~0.8.24, pkgmaker~0.8.17,
    RColorBrewer~1.0-5, registry~0.2, rngtools~1.0,
    stringr~0.6.1, synchronicity~1.1.0, xtable~1.7-0
  \item Loaded via a namespace (and not attached):
    compiler~2.15.2, evaluate~0.4.2, formatR~0.6,
