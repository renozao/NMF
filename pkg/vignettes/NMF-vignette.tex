...
\bibliography{/tmp/Rpkglib_37fa56fea620/NMF/REFERENCES}
...
\begin{tabular}{rrrr}
 ...
 & C & R & Speed.up \\ 
  \hline
brunet & 2.29 & 11.31 & 4.95 \\ 
  lee & 5.54 & 14.41 & 2.60 \\ 
  offset & 5.90 & 20.09 & 3.41 \\ 
  nsNMF & 4.46 & 18.25 & 4.10 \\ 
   \hline
\end{tabular}
...
## brunet    543536   510 0.252   0.252    1
## lee    673513121  1780 1.024   1.024    1
## nsNMF     585106   970 0.748   0.748    1
\end{verbatim}
\begin{alltt}
...
## brunet           0.7488    543536   510 0.252   0.252    1
## lee              0.6764 673513121  1780 1.024   1.024    1
## nsNMF            0.7946    585106   970 0.748   0.748    1
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{itemize}\raggedright
  ...
  \item Other packages: BH~1.51.0-2, bigmemory~4.4.3,
    ...
    BiocGenerics~0.6.0, cluster~1.14.4, knitr~1.4.1,
    NMF~0.18.2, pkgmaker~0.17.4, RColorBrewer~1.0-5,
  ...
  \item Loaded via a namespace (and not attached):
    ...
    evaluate~0.4.7, foreach~1.4.1, formatR~0.9,
    ggplot2~0.9.3.1, grid~3.0.1, gridBase~0.4-6,
    gtable~0.1.2, highr~0.2.1, iterators~1.0.6,
    labeling~0.2, MASS~7.3-29, munsell~0.4.2,
    plyr~1.8, proto~0.3-10, reshape2~1.2.2,
    scales~0.2.3, stringr~0.6.2, tools~3.0.1
\end{itemize}
