...
\bibliography{/tmp/Rpkglib_18a4b35c7b3/NMF/REFERENCES}
...
\begin{tabular}{rrrr}
 ...
 & C & R & Speed.up \\ 
  \hline
brunet & 3.18 & 13.45 & 4.23 \\ 
  lee & 3.24 & 13.18 & 4.06 \\ 
  offset & 5.86 & 20.17 & 3.44 \\ 
  nsNMF & 5.48 & 19.31 & 3.52 \\ 
   \hline
\end{tabular}
...
\hlcomment{# remove the uneeded variable 'Sample' from the phenotypic}
\hlcomment{# data}
esGolub$Sample <- NULL
\end{alltt}
\end{kframe}
...
\hlcomment{# force parallel computation: use option 'P'}
...
## brunet    543536   510 0.280   0.280    1
## lee    673513121  1780 0.992   0.992    1
## nsNMF     585106   970 0.828   0.828    1
\end{verbatim}
\begin{alltt}
...
## brunet           0.7488    543536   510 0.280   0.280    1
## lee              0.6764 673513121  1780 0.992   0.992    1
## nsNMF            0.7946    585106   970 0.828   0.828    1
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\hlfunctioncall{try}(\hlfunctioncall{nmf}(V.neg, 3, my.algorithm, scale.factor = 10))
...
\begin{itemize}\raggedright
  ...
  \item Other packages: BH~1.51.0-1, bigmemory~4.4.3,
    ...
    BiocGenerics~0.6.0, cluster~1.14.4, digest~0.6.3,
    knitr~1.2, NMF~0.17.7, pkgmaker~0.16.4,
    RColorBrewer~1.0-5, registry~0.2, rngtools~1.2,
    synchronicity~1.1.0, xtable~1.7-1
  \item Loaded via a namespace (and not attached):
    codetools~0.2-8, colorspace~1.2-2,
    dichromat~2.0-0, doParallel~1.0.3,
    evaluate~0.4.4, foreach~1.4.1, formatR~0.8,
    ggplot2~0.9.3.1, gridBase~0.4-6, gtable~0.1.2,
    iterators~1.0.6, labeling~0.2, MASS~7.3-27,
