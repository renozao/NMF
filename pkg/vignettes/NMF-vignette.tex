...
\bibliography{/tmp/tmp.EKkeIgMf6U/NMF/REFERENCES}
...
\begin{itemize}\raggedright
  ...
  \item Other packages: bigmemory~4.3.0,
    ...
    NMF~0.9.4, pkgmaker~0.9.7, RColorBrewer~1.0-5,
  ...
  \item Loaded via a namespace (and not attached):
    ...
    plyr~1.7.1, Rcpp~0.10.1, RcppOctave~0.8.11,
    tools~2.15.2
\end{itemize}
