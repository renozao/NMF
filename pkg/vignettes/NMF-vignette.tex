...
%\VignetteDepends{utils,NMF,Biobase,bigmemory,xtable,RColorBrewer}
...
\bibliography{/tmp/Rpkglib_38a4512cb73/NMF/REFERENCES}
...
\begin{tabular}{rrrr}
 ...
 & C & R & Speed.up \\ 
  \hline
brunet & 3.43 & 16.08 & 4.68 \\ 
  lee & 3.63 & 18.53 & 5.10 \\ 
  offset & 5.65 & 23.29 & 4.12 \\ 
  nsNMF & 5.29 & 19.30 & 3.65 \\ 
   \hline
\end{tabular}
...
## brunet          0.6218    543536   510 0.284   0.284    1
## lee             0.4466 673513121  1780 1.088   1.088    1
## nsNMF           0.7350    585106   970 0.856   0.856    1
\end{verbatim}
\begin{alltt}
...
## brunet          0.6218 0.8158  0.3927    543536   510 0.284
## lee             0.4466 0.5789  0.7231 673513121  1780 1.088
## nsNMF           0.7350 0.7895  0.4691    585106   970 0.856
##        cpu.all nrun
## brunet   0.284    1
## lee      1.088    1
## nsNMF    0.856    1
...
\begin{itemize}\raggedright
  ...
  \item Other packages: bigmemory~4.3.0,
    ...
    BiocGenerics~0.4.0, digest~0.6.3,
    doParallel~1.0.1, foreach~1.4.0, iterators~1.0.6,
    knitr~1.1, NMF~0.13, pkgmaker~0.13,
    RColorBrewer~1.0-5, registry~0.2, rngtools~1.1.2,
    synchronicity~1.1.0, xtable~1.7-1
  \item Loaded via a namespace (and not attached):
    codetools~0.2-8, colorspace~1.2-1,
    compiler~2.15.3, evaluate~0.4.3, formatR~0.7,
    gridBase~0.4-6, stringr~0.6.2, tools~2.15.3
\end{itemize}
