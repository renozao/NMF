...
\bibliography{/tmp/Rpkglib_452a8bde452/NMF/REFERENCES}
...
\begin{itemize}\raggedright
  ...
  \item Other packages: BH~1.51.0-1, bigmemory~4.4.3,
    ...
    cluster~1.14.4, digest~0.6.3, knitr~1.2.9, NMF~0.17.6,
    pkgmaker~0.16.4, RColorBrewer~1.0-5, registry~0.2,
    rngtools~1.2, synchronicity~1.1.0
  \item Loaded via a namespace (and not attached):
    codetools~0.2-8, colorspace~1.2-2, dichromat~2.0-0,
    doParallel~1.0.3, evaluate~0.4.3, foreach~1.4.1, formatR~0.7,
    ggplot2~0.9.3.1, gridBase~0.4-6, gtable~0.1.2,
    iterators~1.0.6, labeling~0.1, MASS~7.3-26, munsell~0.4,
