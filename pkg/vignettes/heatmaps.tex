...
\begin{itemize}\raggedright
  ...
  \item Other packages: BH~1.51.0-0, bigmemory~4.4.3,
    ...
    digest~0.6.3, knitr~1.2, NMF~0.17.1, pkgmaker~0.16.2,
    RColorBrewer~1.0-5, registry~0.2, rngtools~1.2,
    synchronicity~1.1.0
  \item Loaded via a namespace (and not attached):
    codetools~0.2-8, colorspace~1.2-2, doParallel~1.0.1,
    evaluate~0.4.3, foreach~1.4.0, formatR~0.7, gridBase~0.4-6,
    iterators~1.0.6, stringr~0.6.2, tools~3.0.1, xtable~1.7-1
\end{itemize}
