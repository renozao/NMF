...
\end{alltt}
\end{kframe}\includegraphics[width=\maxwidth]{/home/renaud/Documents/projects/NMF/Rnmf/pkg/vignettes/figure/heatmaps-heatmap_data} 
\end{knitrout}
...
\begin{itemize}\raggedright
  ...
  \item Other packages: bigmemory~4.3.0, bigmemory.sri~0.1.2,
    ...
    NMF~0.8.27, pkgmaker~0.9.2, RColorBrewer~1.0-5, registry~0.2,
