...
\begin{alltt}
\hlcomment{# random data that follow an 3-rank NMF \hlfunctioncall{model} (with quite some noise:}
\hlcomment{# sd=2)}
...
\end{alltt}
\end{kframe}\includegraphics[width=\maxwidth]{/home/renaud/Documents/projects/NMF/pkg/vignettes/figure/heatmaps-heatmap_data} 
\end{knitrout}
...
\end{alltt}
\end{kframe}\includegraphics[width=\maxwidth]{/home/renaud/Documents/projects/NMF/pkg/vignettes/figure/heatmaps-coefmap_res} 
\end{knitrout}
...
\hlfunctioncall{par}(opar)
\end{alltt}
\end{kframe}\includegraphics[width=\maxwidth]{/home/renaud/Documents/projects/NMF/pkg/vignettes/figure/heatmaps-coefmap_custom} 
\end{knitrout}
...
\hlfunctioncall{par}(opar)
\end{alltt}
\end{kframe}\includegraphics[width=\maxwidth]{/home/renaud/Documents/projects/NMF/pkg/vignettes/figure/heatmaps-basismap_res} 
\end{knitrout}
...
\hlfunctioncall{par}(opar)
\end{alltt}
\end{kframe}\includegraphics[width=\maxwidth]{/home/renaud/Documents/projects/NMF/pkg/vignettes/figure/heatmaps-consensusmap_res} 
\end{knitrout}
...
\end{alltt}
\end{kframe}\includegraphics[width=\maxwidth]{/home/renaud/Documents/projects/NMF/pkg/vignettes/figure/heatmaps-consensusmap_estimate} 
\end{knitrout}
...
\end{alltt}
\end{kframe}\includegraphics[width=\maxwidth]{/home/renaud/Documents/projects/NMF/pkg/vignettes/figure/heatmaps-consensusmap_methods} 
\end{knitrout}
...
\begin{itemize}\raggedright
  ...
  \item Other packages: bigmemory~4.3.0, bigmemory.sri~0.1.2,
    ...
    foreach~1.4.0, gridBase~0.4-5, iterators~1.0.6, knitr~0.8,
    NMF~0.9.1, pkgmaker~0.9.2, RColorBrewer~1.0-5, registry~0.2,
    rngtools~1.0, stringr~0.6.1
  \item Loaded via a namespace (and not attached): evaluate~0.4.2,
    formatR~0.6, plyr~1.7.1, tools~2.15.2, xtable~1.7-0
\end{itemize}
