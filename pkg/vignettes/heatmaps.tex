...
\bibliography{/tmp/Rpkglib_66b537eead03/NMF/REFERENCES}
...
\begin{itemize}\raggedright
  ...
  \item Other packages: bigmemory~4.3.0, bigmemory.sri~0.1.2,
    Biobase~2.16.0, BiocGenerics~0.2.0, digest~0.6.2, knitr~1.0.5,
    NMF~0.10.6, pkgmaker~0.11.3, RColorBrewer~1.0-5, registry~0.2,
  ...
  \item Loaded via a namespace (and not attached):
    ...
    iterators~1.0.6, stringr~0.6.2, tools~2.15.2, xtable~1.7-0
\end{itemize}
