...
\begin{itemize}\raggedright
  ...
  \item Other packages: bigmemory~4.3.0, bigmemory.sri~0.1.2,
    Biobase~2.16.0, BiocGenerics~0.2.0, digest~0.6.2,
    doParallel~1.0.1, foreach~1.4.0, iterators~1.0.6, knitr~1.0.5,
    NMF~0.10.5, pkgmaker~0.11.1, RColorBrewer~1.0-5, registry~0.2,
    rngtools~1.1.1, synchronicity~1.1.0
  \item Loaded via a namespace (and not attached):
    codetools~0.2-8, colorspace~1.2-1, compiler~2.15.2,
    evaluate~0.4.3, formatR~0.7, gridBase~0.4-6, stringr~0.6.2,
