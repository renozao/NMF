...
\bibliography{/tmp/Rpkglib_12191b4b244f/NMF/REFERENCES}
...
\begin{itemize}\raggedright
  ...
  \item Other packages: BH~1.51.0-3, bigmemory~4.4.3,
    ...
    knitr~1.5, NMF~0.19, pkgmaker~0.18.2,
    RColorBrewer~1.0-5, registry~0.2, rngtools~1.2.3,
    synchronicity~1.1.0, xtable~1.7-1
  \item Loaded via a namespace (and not attached):
    codetools~0.2-8, colorspace~1.2-4,
    compiler~3.0.2, dichromat~2.0-0, digest~0.6.3,
    evaluate~0.5.1, formatR~0.9, ggplot2~0.9.3.1,
