...
\bibliography{/tmp/Rpkglib_3e6a4a34b7a0/NMF/REFERENCES}
...
\end{alltt}
\end{kframe}
\includegraphics[width=.48\textwidth]{/home/renaud/Documents/projects/NMF/pkg/vignettes/figure/aheatmaps-clustering1} 
\includegraphics[width=.48\textwidth]{/home/renaud/Documents/projects/NMF/pkg/vignettes/figure/aheatmaps-clustering2} 
...
\hlkwd{aheatmap}\hlstd{(x,} \hlkwc{Rowv} \hlstd{=} \hlstr{"#4"}\hlstd{,} \hlkwc{Colv} \hlstd{=} \hlnum{FALSE}\hlstd{)}
\hlkwd{aheatmap}\hlstd{(x,} \hlkwc{Rowv} \hlstd{=} \hlstr{"#4|!"}\hlstd{,} \hlkwc{Colv} \hlstd{=} \hlnum{FALSE}\hlstd{)}
\hlkwd{aheatmap}\hlstd{(x,} \hlkwc{Colv} \hlstd{=} \hlkwd{list}\hlstd{(}\hlstr{"#3@2"}\hlstd{,} \hlkwc{text_col} \hlstd{=} \hlstr{'red'}\hlstd{,} \hlkwc{text} \hlstd{=} \hlstr{'Cluster B'}\hlstd{),} \hlkwc{Rowv} \hlstd{=} \hlnum{FALSE}\hlstd{)}
\end{alltt}
\end{kframe}
...
\includegraphics[width=0.33\textwidth]{/home/renaud/Documents/projects/NMF/pkg/vignettes/figure/aheatmaps-dendrogram4} 
\includegraphics[width=0.33\textwidth]{/home/renaud/Documents/projects/NMF/pkg/vignettes/figure/aheatmaps-dendrogram5} 
\includegraphics[width=0.33\textwidth]{/home/renaud/Documents/projects/NMF/pkg/vignettes/figure/aheatmaps-dendrogram6} 

\end{knitrout}


\subsection{Forced ordering}
