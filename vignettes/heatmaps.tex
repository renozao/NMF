...
\bibliography{/tmp/Rpkglib_44fe7fce7239/NMF/REFERENCES}
...
\begin{itemize}\raggedright
  ...
  \item Other packages: BH~1.54.0-5, bigmemory~4.4.6,
    bigmemory.sri~0.1.3, Biobase~2.26.0, BiocGenerics~0.12.0,
    cluster~1.15.3, knitr~1.7, NMF~0.21.3, pkgmaker~0.25.9,
  ...
  \item Loaded via a namespace (and not attached):
    ...
    gtable~0.1.2, highr~0.4, iterators~1.0.7, magrittr~1.0.1,
